...
import { IPath, RequirementType } from "utils/constant";
  ...
  return (
    <AdminLayout overflow="hidden" height="100vh">
      ...
      <Portal>
        <Box>
          <Navbar
            paths={[{path: `/${IPath.TASKS}`, name: 'Crowdsourcing Management'},{path: `/${IPath.MYREQUIREMENT}`, name: 'My Requirements'}, {path: '#', name: 'Publish Requirement'}]}
          />
        </Box>
      </Portal>
