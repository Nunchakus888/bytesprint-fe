...
export default function EngineerItem(props: {
	item: any
}) {
	return (
        ...
        <Flex justify="space-between" width="100%" position="relative">
          ...
          <Flex justifyContent="center" direction="column" alignItems="flex-start" gap="10px">
            <Flex justifyContent="center" gap="10px"><Text>2023-至今</Text><Text>上海奇石信息技术有限公司 · Java开发工程师</Text></Flex>
            <Flex justifyContent="center" gap="10px"><Text>2023-至今</Text><Text>苏州大学 · 信息工程</Text></Flex>
          </Flex>

          <Flex direction="column" justifyContent="space-between" alignItems="flex-end">
            <Box fontSize={16}>提交时间：2023/11/12 10:12:12</Box>
            <Button width="100px" background="#7551FF" size='md' color="#fff">
              <Link href={`/${IPath.ENGINEERManage}/11`}> 认证审核</Link>
            </Button>
          </Flex>
        </Flex>
